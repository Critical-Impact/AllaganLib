...
public class ItemAuxesiaSource(ItemRow item, ItemRow costItem, ItemSupplement supplement)
    : ItemSupplementSource(item, costItem, supplement, ItemInfoType.Auxesia);
