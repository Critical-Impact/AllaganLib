...
public class CollectablesShopSheet : ExtendedSheet<CollectablesShop, CollectablesShopRow, CollectablesShopSheet>, IExtendedSheet
{
    ...
    {
        return this.shopCache.GetNpcsByCollectablesShopId(shopId)?.ToList() ?? [];
    }
