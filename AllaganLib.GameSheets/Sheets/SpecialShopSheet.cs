    ...
    public Dictionary<uint, uint> TomestoneLookup
    {
        get
        {
            ...
            var tomeStones = this.GameData.GetExcelSheet<TomestonesItem>()!
                .Where(t => t.Tomestones.RowId > 0 && t.CurrencyInventorySlot > 0) // CurrencyInventorySlot is the InventorySlot the Currency is stored in. When it's -1 it appears to reference a field directly in InventoryManager
