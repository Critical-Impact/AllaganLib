...
- AllaganLib.GameSheets
  - LuminaSupplemental.Excel updated to 5.1.5
  - Minor optimizations
  - BST support

- AllaganLib.Monitors
  - Add some extra handlers for shops we might have missed
...
### Changed
- AllaganLib.GameSheets
  - LuminaSupplemental.Excel updated to 4.3.2
  - Fixed Craft Leve exp reward

## [2.2.0] - 2026-05-02
### Changed
- AllaganLib.GameSheets
  - LuminaSupplemental.Excel updated to 4.3.1
  - Update for 7.5

## [2.1.7] - 2026-04-26
### Changed
- AllaganLib.GameSheets
  - LuminaSupplemental.Excel updated to 4.2.4
...
### Added
- AllaganLib.GameSheets
  - Added ENpcBase extensions and extra ItemRow properties
...
### Added
- AllaganLib.GameSheets
  - Added SharedModelCache
  - Added RoleType to ClassJobRow
  - Added QuestDialogue sheet

- AllaganLib.Monitors
  - ShopMonitorService now provides the list of shops, subshops and active shop when visiting a vendor with a nested menu(topic select)
...
### Changed
- AllaganLib.GameSheets
  - LuminaSupplemental updated to 4.1.0

## [2.0.1] - 2025-12-22

### Changed
- AllaganLib.GameSheets
  - Use Experimental Sheets for quest due to bug in Lumina
...
### Fixed
- AllaganLib.Monitors
  - Provide the correct order of the shops

## [1.3.11] - 2025-11-17

### Fixed
- AllaganLib.GameData
  - Fix crash when GameData is loaded in a non-english language
...
### Changed
- AllaganLib.GameData
  - Bumped LuminaSupplemental.Excel to 3.0.5
  - Update for 7.35
...
### Fixed
- AllaganLib.GameData
  - Bumped LuminaSupplemental.Excel to 3.0.4
...
### Fixed
- AllaganLib.Data
  - Fixed an issue in CsvLoaderService when loading a file with the wrong line separators

- AllaganLib.Interface
  - StringColumn's will now properly filter
  - HelpMarkers can now be coloured
